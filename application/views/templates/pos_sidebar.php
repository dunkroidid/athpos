                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li style="display:none"><a><i class="fa fa-home"></i> Home <span
                            ...
                            <li><a><i class="fa fa-shopping-cart"></i> Transaksi <span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <?php if ($user['TIPE'] != 'Administrator') : ?>
                                    <li style="display:none"><a href="<?php echo base_url('pembelian/index') ?>">Entry
                                            Pembelian</a></li>
                                    <li style="display:none"><a href="<?php echo base_url('dpembelian/index') ?>">Daftar
                                            Pembelian</a></li>
                                    <?php else : ?>
                            ...
                            <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-desktop"></i> Master Data <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
                            <li><a><i class="fa fa-desktop"></i> Master Data <span
                                ...
                                <ul class="nav child_menu">
                                    <li><a>Data Barang<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="sub_menu"><a href="<?php echo base_url('barang/index') ?>">Data
                                                    Item</a>
                                            </li>
                                    ...
                                    <li><a href="<?php echo base_url('barang/barang_operasional') ?>">Barang
                                            Operasional</a></li>
                                    <li><a href="<?php echo base_url('barang/barang_rusak') ?>">Barang Rusak</a></li>
                                </ul>
                            </li>
                            <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-money"></i> Keuangan <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
                                ...
                                <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-file-text-o"></i> Laporan <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
                            <li><a><i class="fa fa-file-text-o"></i> Laporan <span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="<?php echo base_url('laporan/stokopname') ?>">Laporan Stok Opname</a>
                                    </li>
                                    ...
                                    <li><a href="<?php echo base_url('laporan/barang_operasional') ?>">Laporan Barang
                                            Operasional</a></li> -->
                                    <li><a href="<?php echo base_url('laporan/barang_rusak') ?>">Laporan Barang
                                            Rusak</a></li>
                            ...
                            <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-user"></i> Management User <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
                            <li><a><i class="fa fa-user"></i> Management User <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php endif; ?>
                                <ul class="nav child_menu">
                            ...
                            <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-bar-chart-o"></i> Grafik <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
                            ...
                            <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-magic"></i> Tools <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
                            ...
                            <?php if ($user['TIPE'] != 'Administrator') : ?>
                            <li style="display:none"><a><i class="fa fa-gears"></i> Setting <span
                                        class="fa fa-chevron-down"></span></a>
                                <?php else : ?>
