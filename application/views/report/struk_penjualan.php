...
$pdf->Cell(70,6,$profil['NAMA_PERUSAHAAN'],0,1, 'C');
$pdf->SetFont('helvetica','',9);
$pdf->Cell(70,2,$profil['ALAMAT_PERUSAHAAN'],0,1, 'C');
$pdf->SetFont('helvetica','',8);
$pdf->Cell(70,6,'Telp : '.$profil['TELP_PERUSAHAAN'].' / Fax : '.$profil['FAX_PERUSAHAAN'],0,1, 'C');
