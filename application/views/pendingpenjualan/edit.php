    			...
    			<div class="col-md-12 col-sm-12 col-xs-12">
    				<div class="x_panel">
    					...
    					<div class="x_content">
    						<div class="row">
    							<div class="col-md-12 col-sm-12 col-xs-12">
    								<h2 style="text-align: right"> Invoice <b><?=$val['INVOICE'];?></b></h2>
    							</div>
    						</div>
    						<div class="row">
    							...
    							<div class="col-md-3 col-sm-12 col-xs-12">
    								<h1 style="text-align: right" id="subtot"><?=$val['total']?></h1>
    							</div>
    						</div>
    					</div>
    				</div>
    					...
    					<div class="x_panel">
    						...
    						<div class="x_content">
    							...
    							<div style="text-align: right">
    								<button type="button" onclick="tambahitembarang('<?=$val['ID_JUAL']?>')" class="btn btn-success btn-sm"><i class="fa fa-shopping-cart m-right-xs"></i> Tambah</button>
    							</div>
    						</div>
    					</div>
    				</div>
    							...
    							<table id="editDetil" width="100%" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$d['subtotal']?></td>
                                            <td>
                                                <a href="#" class="btn btn-primary btn-xs" title="Edit Data" onclick="editDetilItem('<?=$d['id_detil_jual']?>')"><i class="fa fa-edit"></i></a> 
                                                <a href="#" class="btn btn-danger btn-xs" title="Hapus Data" onclick="hapusDetilItemPending('<?=$d['id_detil_jual']?>')"><i class="fa fa-trash "></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
							  <input type="text" class="form-control" name="grandtotal" id="grandtotal" readonly>
    							...
    							<div style="text-align: right" class="pt-3">
    								...
    								<button type="button" onclick="editPenjualan('<?=$val['ID_JUAL']?>')" class="btn btn-primary"><i class="fa fa-paper-plane-o m-right-xs"></i> Payment</button>
    							</div>
    						</div>
    					</div>
    				</div>
